...
This YAML doesn't show the authors in the final output. A solution is using something like this: 
```yaml
author: Jimi Hendrix ^[Senior Analyst, University of Rock. Contact@Jimi.com] 
```
